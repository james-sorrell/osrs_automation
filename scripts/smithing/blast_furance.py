...
COAL_LOC = (135, 120, 145, 130)
MITH_LOC = (325, 120, 335, 130)
...
def getOre(ore):
    if ore == "coal":
        b.per.moveToBox(COAL_LOC, 'medium')
    elif ore == "mith":
        b.per.moveToBox(MITH_LOC, 'medium')
    t.randomSleep(20, 5)
    b.per.click('left')
...
def getBarsFromDispensor():
    while b.detection.isInventoryFull() is False:
        ...
        b.per.moveToBox(DISP_BAR_LOC, 'medium')
        t.randomSleep(20, 5)
        b.per.click('left')
...
def emptyLootingBag():
    ...
    b.per.moveToBox(EMPTY_LOC, 'medium')
    t.randomSleep(20, 5)
    b.per.click('left')
    t.randomSleep(125, 15)

def drinkStaminaPotion():
    POT_LOC = (230, 230, 240, 240)
    b.per.moveToBox(POT_LOC, 'medium')
    t.randomSleep(20, 5)
    b.per.click('right')
    x, y = b.per.mousePosition()
    WD1_LOC = [x-1, y+41, x+1, y+43] 
    b.per.moveToBox(WD1_LOC, 'medium')
    t.randomSleep(20, 5)
    b.per.click('left')
    b.per.moveToBox(BANK_X, 'medium')
    t.randomSleep(20, 5)
